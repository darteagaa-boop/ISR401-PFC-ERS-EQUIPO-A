...
| Nombre | Rol |
|---|---|
| Integrante A | Bloque A — Inspección Fagan y Fundamento teórico 3.1–3.3 |
| Integrante B | Bloque B — Gestión del cambio (CCB) y RFC |
...
Dependencias: distribución LaTeX completa (MiKTeX o TeX Live).
